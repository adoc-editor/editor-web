      ...
      function Octokit(clientOptions) {
        ...
        GitRepo = (function() {
          function GitRepo(repoUser, repoName) {
            ...
            this.updateFile = function(path, message, sha, content, encodeInBase64) {
              var _this = this;
              ...
              return _request('PUT', "" + _repoPath + "/contents/" + path, payload).then(function(res) {
                return res;
              });
            };
          ...
          Search = (function() {
              function Search() {
                  ...
                  _search = function(type, q, sort, order) {
                      ...
                      return _request('GET', '/search/' + type + toQueryString(params) + '&q=' + q, null);
                  };
